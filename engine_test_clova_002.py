...
INPUT_PATH = "test_002_context_length_json.json"
OUTPUT_PATH = "results_clovax_002.json"
...
def run_test():
    ...
    for case in test_cases:
        try:
            ...
            results.append({
                "id": case["id"],
                "expected_password": case.get("expected_password") or case.get("password", ""),
                "predicted": predicted,
                "match": predicted == (case.get("expected_password") or case.get("password", ""))
            })
